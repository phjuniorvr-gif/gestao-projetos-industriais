      ...
      activities: [
        {
          ...
          name: 'Atividade',
          tasks: [
            { id: 't1', rowNumber: 1, activityId: 'a1', name: 'T1', category: 'eletrica', dependencies: [], plannedStart: '2026-01-01', plannedEnd: '2026-01-02', baseStart: '2026-01-01', baseEnd: '2026-01-02', confirmedByAdmin: true, status: 'planned', isBlocked: false, isStartDelayed: false, isLateCompletion: false, hasDependencyViolation: false, predecessorRowNumbers: [], pendingConfirmation: false },
          ],
          status: 'planned',
          blockedCount: 0,
          startDelayedCount: 0,
